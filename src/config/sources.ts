...
export const TRUSTED_SOURCES: SourceDomain[] = [
  ...
  },
  {
    ...
    priority: 1,
    language: "en",
    focus: "Realtidsdata om våldsamma händelser, dödstal och aktörer per konflikt",
  },
  {
    domain: "ucdp.uu.se",
    ...
    priority: 1,
    language: "en",
    focus: "Akademisk konfliktdatabas, dödstal, konflikttyper sedan 1946",
  },
  {
    ...
    priority: 1,
    language: "en",
    focus: "Djupanalys per konflikt, varningssignaler, aktörskartor",
  },
  {
    domain: "childrenandarmedconflict.un.org",
    name: "UN CAAC – Barn i väpnade konflikter",
    type: "un",
    priority: 1,
    language: "en",
    focus: "FN:s officiella rapporter om barn i krig, Six Grave Violations",
  },
  {
    domain: "prio.org",
